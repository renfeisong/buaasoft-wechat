...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#panel-book" role="tab" data-toggle="tab">通讯录管理</a></li>
    <li role="presentation"><a href="#panel-format" role="tab" data-toggle="tab">展示信息管理</a></li>
</ul>

<div class="tab-content">
    <div role="tabpanel" class="tab-pane fade in active" id="panel-book">
        <h3>通讯录管理</h3>
        <p>这里是对系统内部用户表的补充，添加到此处的信息也可被同学们查到。</p>
    ...
    <div role="tabpanel" class="tab-pane fade" id="panel-format">
