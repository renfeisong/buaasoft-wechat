...
<div role="tabpanel" class="tab-pane fade in active" id="manual">
    <div class="send-panel">
        <div class="form-group">
            ...
            <div class="control">
                <input class="form-control" type="text" name="postUrl-1" id="postUrl-1" value="<?php echo ROOT_URL ?>index.php" required>
            </div>
        </div>
        <div class="form-group">
            <div class="prompt">
...
<div role="tabpanel" class="tab-pane fade" id="message">
    <div class="send-panel">
        <div class="form-group">
            ...
            <div class="control">
                <input class="form-control" type="text" name="postUrl-2" id="postUrl-2" value="<?php echo ROOT_URL ?>index.php" required>
            </div>
        </div>
        <div class="form-group">
            <div class="prompt">
...
<div role="tabpanel" class="tab-pane fade" id="event">
    <div class="send-panel">
        <div class="form-group">
            ...
            <div class="control">
                <input class="form-control" type="text" name="postUrl-3" id="postUrl-3" value="<?php echo ROOT_URL ?>index.php" required>
            </div>
        </div>
        <div class="form-group">
            <div class="prompt">
...
<div role="tabpanel" class="tab-pane fade" id="log">
    <table class="table">
        ...
        add_row('MySQL 数据库大小', $size[DB_NAME]->size . "K");
        ?>
    </table>
</div>
</div>
